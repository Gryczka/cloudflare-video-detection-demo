/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e0f27b8e452a5a5714148e1acb289406)
...
interface __BaseEnv_Env {
	...
	BUDGET: DurableObjectNamespace<import("./src/worker").BudgetCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "BudgetCounter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_DEMO_MODE" | "DEMO_DETECT_DAILY_CAP" | "DEMO_PPE_DAILY_CAP" | "USAGE_ALERT_THRESHOLD" | "DAILY_SPIKE_THRESHOLD" | "REPORT_EMAIL_TO" | "REPORT_EMAIL_FROM" | "SELF_HOST_URL" | "CF_ACCOUNT_ID">> {}
}
